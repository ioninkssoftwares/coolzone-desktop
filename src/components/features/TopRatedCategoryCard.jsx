...
const TopRatedCategoryCard = ({ categoryData }) => {
    return (
        <div key={categoryData.id} style={{ width: "375px", height: "150px" }} className=' rounded-lg bg-white font-semibold cursor-pointer hover:scale-105 flex items-center justify-start p-4 gap-8 '>
