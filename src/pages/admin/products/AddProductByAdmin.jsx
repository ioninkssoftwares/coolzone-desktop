                    ...
                    <div className='bg-gray-50'>
                        ...
                        <div className="flex items-center justify-between mx-10 my-5">
                            ...
                            <div className="flex gap-7">
                                ...
                                <button className="px-4 py-2 rounded-lg text-white bg-primary-blue">
                                    Save & Publish
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-white mx-10  flex  gap-5 ">
                            <div className="basis-[70%] flex gap-10">
                                <div className="basis-[45%] p-10">
                                    ...
                                    <FormControl fullWidth>
                                        <InputLabel id="demo-simple-select-label">Quantity in Stock</InputLabel>
                                        <Select
                                            labelId="demo-simple-select-label"
                                            id="demo-simple-select"
                                            // value={clients}
                                ...
                                <div className="basis-[45%] p-10">
                                    <Textarea placeholder="Short Description" minRows={3} />

                                    <Typography sx={{ my: 1, color: "gray" }} id="modal-modal-title" variant="p" component="p">
                                        Product Long Description
                                    </Typography>

                                    <Textarea placeholder="Your text goes here" minRows={5} />
